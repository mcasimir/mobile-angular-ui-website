...
module.exports = {
  defineTags: function(dictionary) {
    ...
    dictionary.defineTag('position', {
      mustHaveValue: true,
      onTagged: function(doclet, tag) {
        doclet.position = parseInt(tag.value);
      }
    });

    dictionary.defineTag('shortname', {
      mustHaveValue: true,
      onTagged: function(doclet, tag) {
        doclet.shortname = tag.value;
      }
    });
    ...
    dictionary.defineTag('priority', {
      ...
      onTagged: function(doclet, tag) {
        if (!doclet.directive) { return; }
        doclet.directive.priority = parseInt(tag.value);
      }
    });
